                                                     ...
                                                     <?php $id_kwu = 1;
                                                        foreach ($kewirausahaan as $s) { ?>
                                                         <tr>
                                                             ...
                                                             <td>
                                                                 <a href="<?= base_url('tatausaha/detail_kwu') . '/' . $s->id_kwu; ?>" class="btn btn-success btn-sm">Detail</a>
                                 ...
                                 <div class="modal-dialog modal-dialog-centered" role="document">
                                     <div class="modal-content">
                                         ...
                                         <div class="modal-body">
                                             <form id="myForm" action="<?php echo site_url('User/save_kewirausahaan') ?>" method="post" enctype="multipart/form-data">
                                                 ...
                                                 <div class="form-group">
                                                     ...
                                                     <input required type="text" class="form-control" id="nama_usaha" name="nama_usaha" placeholder="Nama Usaha">
                                                 </div>

                                                 <div class="form-group">
                                                     <label for="jenis_usaha">Jenis Usaha*</label>
                                                     <input required type="text" class="form-control" id="jenis_usaha" name="jenis_usaha" placeholder="Jenis Usaha">
                                                 </div>
                                 ...
                                 <div class="modal-dialog" role="document">
                                     <div class="modal-content">
                                         ...
                                         <div class="modal-footer">
                                             ...
                                             <a id="btn-delete" class="btn btn-danger" href="<?php echo site_url('User/delete_kwu/' . $s->id_kwu) ?>">Delete</a>
                                         </div>
                                     </div>
                                 </div>
                             </div>
                                 ...
                                 <div class="modal fade" id="update_kwu<?= $s->id_kwu ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                                     <div class="modal-dialog modal-dialog-centered" role="document">
                                         <div class="modal-content">
                                             ...
                                             <div class="modal-body">
                                                 <form id="myForm" action="<?php echo site_url('User/update_kwu/' . $s->id_kwu); ?>" method="post" enctype="multipart/form-data">
                                                     ...
                                                     <div class="form-group">
                                                         ...
                                                         <select name="program_studi" id="inputState" class="form-control" required>
                                                             <?php if ($s->program_studi == '') { ?>
                                                                 <option selected>Pilih...</option>
                                                             <?php } else { ?>
                                                                 <option selected><?php echo $s->program_studi; ?></option>
                                                             <?php } ?>
                                                             <option value="D4-Rekayasa Perancangan Mekanik">D4-Rekayasa Perancangan Mekanik</option>
                                                             <option value="D4-Teknologi Rekayasa Kimia Industri">D4-Teknologi Rekayasa Kimia Industri</option>
                                                             <option value="D4-Teknologi Rekayasa Otomasi">D4-Teknologi Rekayasa Otomasi</option>
