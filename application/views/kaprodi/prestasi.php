                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="<?= base_url('kaprodi/detail_prestasi') . '/' . $row->id; ?>" class="btn btn-success btn-sm">Detail</a>
                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    ...
                                    <a id="btn-delete" class="btn btn-danger" href="<?php echo site_url('Kaprodi/delete/' . $row->id) ?>">Delete</a>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="modal-dialog modal-dialog-centered" role="document">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <form id="myForm" action="<?php echo site_url('Kaprodi/update_prestasi/' . $row->id); ?>" method="post" enctype="multipart/form-data">


                                            <div class="form-group">
                                                <label for="nama">Nama*</label>
                                                <input required type="text" class="form-control" id="nama" name="nama" value="<?= $row->nama ?>" placeholder="Masukkan Nama">
                                            </div>

                                            <div class="form-group">
                                                <label for="nim">NIM*</label>
                                                <input required type="text" class="form-control" id="nim" name="nim" value="<?= $row->nim ?>" placeholder="Masukkan NIM">
                                            </div>
